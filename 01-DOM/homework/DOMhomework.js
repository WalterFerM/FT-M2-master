...
// Tu código acá:
document.querySelector('#createdBy').innerHTML = 'Aplication create by ~ Walter Meneses.'
...
if(todo.complete===true) toDoText.className = 'completeText'; checkbox.checked = true;
...
function displayToDos() {
  ...
  let arrayDiv = buildToDos(toDoItems);
...
if(!input.value) return alert('To-Do is Empty');
